...
<!-- wp:cover {"useFeaturedImage":true,"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder-banner.webp","dimRatio":40,"overlayColor":"header-image-overlay","minHeightUnit":"vh","isDark":false,"align":"full","className":"hero-image"} -->
	<div class="wp-block-cover alignfull is-light hero-image">
		...
		<img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder-banner.webp" data-object-fit="cover"/>
