...
/**
 * Title: Sidebar
 * Slug: janeth-salon-theme/sidebar
...
<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e( 'Search the website', 'janeth-salon-theme' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"style":{"typography":{"fontSize":"1.6rem"}},"className":"wp-block-heading"} -->
<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e( 'Useful Links', 'janeth-salon-theme' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'Links I found useful and wanted to share.', 'janeth-salon-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Full site editing in WordPress', 'janeth-salon-theme' ); ?>","url":"#","isTopLevelLink":true,"className":"is-style-arrow-link","style":{"typography":{"textDecoration":"underline"}}} /-->

<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Classic themes vs block themes', 'janeth-salon-theme' ); ?>","url":"#","isTopLevelLink":true,"className":"is-style-arrow-link","style":{"typography":{"textDecoration":"underline"}}} /-->

<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Janeth Salon theme documentation', 'janeth-salon-theme' ); ?>","url":"#","isTopLevelLink":true,"className":"is-style-arrow-link","style":{"typography":{"textDecoration":"underline"}}} /-->
<!-- /wp:navigation --></div>
<!-- /wp:group -->
