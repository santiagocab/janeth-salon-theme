...
/**
 * Title: Contact
 * Slug: janeth-salon-theme/contact
...
<h2 class="has-text-align-center wp-block-heading"><?php esc_html_e( 'Contact Us', 'janeth-salon-theme' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"6px"}}} -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="border-radius:6px"><?php esc_html_e( 'Get in touch', 'janeth-salon-theme' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover -->
